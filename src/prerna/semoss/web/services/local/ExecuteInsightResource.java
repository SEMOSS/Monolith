...
public class ExecuteInsightResource {
	...
	public Object generateInsight(@Context HttpServletRequest request, @PathParam("appId") String projectId,
		...
		try {
			...
			try {
				...
				errorMap.put(Constants.ERROR_MESSAGE,
						"Error occured creating the insight. Detailed message = " + e2.getMessage());
				return WebUtility.getResponse(errorMap, 401);
