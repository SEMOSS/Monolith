...
public class DHMSMDeploymentFunctions extends AbstractControlClick {
	...
	public StreamingOutput refreshDataRegion(MultivaluedMap<String, String> form, 
        ...
        Hashtable retHash = ((DHMSMDeploymentStrategyPlaySheet) playsheet).refreshReport(webDataHash, false);
	...
	@Path("deployment")
    @Produces("application/json")
	public StreamingOutput refreshDataDeployment(MultivaluedMap<String, String> form, 
            @Context HttpServletRequest request) {
		Gson gson = new Gson();
        Hashtable<String, Object> webDataHash = gson.fromJson(form.getFirst("data"), new TypeToken<Hashtable<String, Object>>() {}.getType());
        Hashtable retHash = ((DHMSMDeploymentStrategyPlaySheet) playsheet).refreshReport(webDataHash, true);        
		return WebUtility.getSO(retHash);
	}
