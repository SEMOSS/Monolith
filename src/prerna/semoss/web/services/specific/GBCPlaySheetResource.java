...
public class GBCPlaySheetResource {
	...
	public Object registerTopLevelGridClick(MultivaluedMap<String, String> form, @Context HttpServletRequest request)
	{
		...
		GBCPresentationPlaySheet playsheet = (GBCPresentationPlaySheet) this.preparePlaySheet(query, "prerna.ui.components.specific.cbp.GBCPresentationPlaySheet", "Drilling " + uri, uri, request);		
		playsheet.setPlaySheetClassName("prerna.ui.components.playsheets.ComparisonColumnChartPlaySheet");
		
		return this.runPlaySheet(playsheet);
	}	
	...
	public Object registerMetricClick(MultivaluedMap<String, String> form, @Context HttpServletRequest request)
	{
		...
		Hashtable<String, ArrayList<String>> donwstreamGraphs = getDownstreamGraphs(uri);
